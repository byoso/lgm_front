  ...
  <table class="table is-bordered is-fullwidth">
    ...
    <tbody>
      <tr v-for="table in tables_as_owner" :key="table.id">
        <td class="clickable" @click="selectTable" :id="table.id"><a>{{ table.name }}</a></td>
        <td>
          <ul>
        ...
        <td><span class="button is-warning is-small">Edit</span></td>
      </tr>
    </tbody>
  </table>
<br>
...
export default {
  ...
  methods: {
    selectTable(event) {
      console.log('selectTable', event.target.id);
    }
  }
}
</script>
